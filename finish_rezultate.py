  ...
  <section class="cta-section">
    <div class="container">
      <div class="cta-box">
        ...
        <span class="section-tag">Începe Acum</span>
        <h2>Obține Rezultate Similare<br><span class="gold">cu propriul tău set de Prompturi.</span></h2>
        <p>Nu contează nivelul tău actual. Inteligența artificială poate fi deblocată pentru a-ți oferi acest avantaj competițional chiar acum.</p>
        <a href="shop.html" class="btn-primary btn-large">Vezi Toate Produsele →</a>
      </div>
    </div>
  </section>
"""

# Find <section class="page-hero"> and <footer>
...
if start_idx != -1 and end_idx != -1:
    ...
    print("Rebuilt rezultate.html accurately.")
else:
